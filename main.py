...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{20}: Change Race Wins         1K'))
            print(Colorate.Horizontal(Colors.rainbow, '{21}: Change Race Loses        1K'))
            print(Colorate.Horizontal(Colors.rainbow, '{22}: Clone Account            7K'))
            ...
            if service == 0: # Exit
                ...
                if amount > 0 and amount <= :
